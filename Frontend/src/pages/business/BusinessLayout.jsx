      ...
      <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div>
            ...
            <p className="text-slate-400 text-xs font-medium mt-0.5">Panel Negocio</p>
          </div>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="px-4 py-4 border-t border-slate-100">
        <div className="flex items-center gap-3 mb-2 px-2">
          <div className="w-8 h-8 rounded-full bg-violet-100 flex items-center justify-center shrink-0">
            <span className="text-violet-600 font-bold text-sm">{user?.name?.[0]?.toUpperCase()}</span>
          </div>
        ...
        <NavLink
          ...
          onClick={onClose}
          className={({ isActive }) =>
            `w-full flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all ${
              isActive ? 'bg-violet-100 text-violet-600' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700'
            }`
          }
        >
